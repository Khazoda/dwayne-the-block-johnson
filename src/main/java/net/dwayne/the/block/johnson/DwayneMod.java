...
public class DwayneMod implements ModInitializer {
  ...
  public static final ItemGroup DWAYNE_ITEMGROUP = DwayneModItemGroup.createItemGroup();
  ...
  public void onInitialize() {
    Registry.register(Registries.ITEM_GROUP, new Identifier("dwayne-the-block-johnson"), DWAYNE_ITEMGROUP);
    // Items
